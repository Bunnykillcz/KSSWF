...
//------------------------------------------------------------//
	...
	function socials($input) 
	{
		...
		if($input == "all")
		{
			...
			$final_output .= "<a href='https://www.facebook.com/sharer.php?u=".$url."'>";
			$final_output .= icon("fb-s",0);
			$final_output .= "</a>";	
			
			$final_output .= "<a href='https://plus.google.com/share?url=".$url_google."'>";
			$final_output .= icon("google-s",0);
			$final_output .= "</a>";
			
			$final_output .= "<a href='https://www.twitter.com/intent/tweet?url=".$url."&text=".$text."'>";
