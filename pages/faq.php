...
<p>Also - don't forget to clear the cache, otherwise the script won't generate the new menu (If you're unsure about the changes, save the last generated file before doing so).</p><div class="right"><a href="index.php?c=1"><?php echo icon("bin",0); ?> [CLEAR CACHE] </a></div>
<h2>02</h2>
<p> ### </p>
