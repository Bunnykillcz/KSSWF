...
<span class="string">string</span> order <i>(optional)</i>, <span class="bool">bool</span> cache_all <i>(optional)</i>,
 <span class="string">string</span> OR <span class="int">int</span> release_frequency <i>(optional)</i>, <span class="string">string</span> release_folder <i>(optional)</i>, <span class="int">int</span> release_amount <i>(optional)</i>);</h2>
...
<p><span class="string">string</span> OR <span class="int">int</span> <i>release_time</i> <i>(optional)</i> expects "hour", "day", "week", "month", "year", OR ANY time in minutes as a number. This is optional for releasing new images to the gallery every *release_time* from the first load-up.</p>
...
<br/>
<p><span class="int">int</span> <i>release_amount</i> <i>(optional)</i> expects number of how many images you wanna release per interval.</p>
