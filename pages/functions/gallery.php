...
<p><span class="string">string</span> folder is the key parameter. It references to "./img/"+folder and the function shows its contents as an image gallery. </p>
<p><span class="string">string</span> title <i>(optional)</i> is the title of your gallery. </p>
<p><span class="string">string</span> order <i>(optional)</i> expects "abc", "cba", or "random". Anything else will be considered "abc", as default. </p>
<p><span class="bool">bool</span> cache_all <i>(optional)</i> is a boolean value, default: false; If you don't need to count your items, I suggest you to turn it on (true) since it should make your page load faster.</p>
<br/>
