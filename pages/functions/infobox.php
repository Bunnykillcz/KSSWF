...
<p><span class="function">function</span> <b>infobox</b> pops up a predefined message window.</p>
<p><span class="string">string</span> <i>message</i> expects a text/string value of any kind. This could be something like "ERROR 1234", etc.</p>
