<h1>Functions</h1>
<h2>slideshow(var identifier, string folder, bool show_controls_arrow, bool show_controls_dots, int time, string effect, int size_x, int size_y);</h2>
...
<p>int <i>size_x</i>, <i>size_y</i> sets size of the slideshow. If any of them is set as 0, the size is default.</p>
<br/>
...
<pre><code class="language-php" style="display:block; height: 64px;">	
	&lt;?php 
		slideshow(0,"gallery",true,true,2000,"fade",300,200); 
