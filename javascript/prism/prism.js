...
!function(a) {
    ...
    a.languages.insertBefore("inside", "attr-name", {
        spread: {
            pattern: /\{\.{3}\w+\}/,
            inside: {
                punctuation: /\{|\}|\./,
...
!function(e) {
    ...
    e.hooks.add("before-highlight", function(e) {
        "smarty" === e.language && (e.tokenStack = [],
        e.backupCode = e.code,
        e.code = e.code.replace(t, function(t) {
            if (t === n && (o = !1),
            !o) {
                t === a && (o = !0);
                for (var r = e.tokenStack.length; -1 !== e.backupCode.indexOf("___SMARTY" + r + "___"); )
                    ++r;
                return e.tokenStack[r] = t,
                "___SMARTY" + r + "___"
            }
            return t
        }))
    ...
    e.hooks.add("before-insert", function(e) {
        "smarty" === e.language && (e.code = e.backupCode,
        delete e.backupCode)
    }),
...
!function(e) {
    ...
    e.languages.textile.tag.pattern = /<\/?(?!\d)[a-z0-9]+(?:\s+[^\s>\/=]+(?:=(?:("|')(?:\\\1|\\?(?!\1)[\s\S])*\1|[^\s'">=]+))?)*\s*\/?>/i,
...
!function() {
    ...
    if ("undefined" != typeof self && self.Prism && self.document && document.querySelector) {
        ...
        Prism.hooks.add("complete", function(e) {
            ...
            t && r && /pre/i.test(t.nodeName) && (clearTimeout(o),
            n(t, r),
            o = setTimeout(i, 1))
        }),
...
!function() {
    function e(e) {
        ...
        if (t.HTML[a] = 0,
        0 !== t.SVG[e] && "undefined" != typeof document) {
        ...
        return t.SVG[e] = 0,
        0 !== t.MathML[e] && 0 === e.indexOf("m") ? (t.MathML[e] = 1,
        "mathml") : (t.MathML[e] = 0,
        null )
    }
    if (("undefined" == typeof self || self.Prism) && ("undefined" == typeof global || global.Prism)) {
        ...
        Prism.hooks.add("wrap", function(t) {
            if (("tag-id" == t.type || "property" == t.type && 0 != t.content.indexOf("-") || "rule" == t.type && 0 != t.content.indexOf("@-") || "pseudo-class" == t.type && 0 != t.content.indexOf(":-") || "pseudo-element" == t.type && 0 != t.content.indexOf("::-") || "attr-name" == t.type && 0 != t.content.indexOf("data-")) && -1 === t.content.indexOf("<") && ("css" == t.language || "scss" == t.language || "markup" == t.language)) {
                ...
                "css" == t.language || "scss" == t.language ? (s += "wiki/css/",
                "property" == t.type ? s += "properties/" : "rule" == t.type ? s += "atrules/" : "pseudo-class" == t.type ? s += "selectors/pseudo-classes/" : "pseudo-element" == t.type && (s += "selectors/pseudo-elements/")) : "markup" == t.language && ("tag-id" == t.type ? (a = e(t.content) || a,
                s += a ? "wiki/" + a + "/elements/" : n) : "attr-name" == t.type && (s += a ? "wiki/" + a + "/attributes/" : n)),
                s += t.content,
                t.attributes.href = s,
    ...
    if ("undefined" != typeof self && self.Prism && self.document && document.createElement) {
        var e = {
          ...
          , i = function(e, a) {
            ...
            !n && a.parentNode && "pre" === a.parentNode.tagName.toLowerCase() && (n = a.parentNode.getAttribute("data-dependencies")),
            n = n ? n.split(/\s*,\s*/g) : [],
            t(n, function() {
                l(e, function() {
          ...
          , l = function(a, s, i) {
            var l = function() {
                ...
                var t = c[a];
                if (t || (t = c[a] = {}),
                s && (t.success_callbacks || (t.success_callbacks = []),
                t.success_callbacks.push(s)),
                i && (t.error_callbacks || (t.error_callbacks = []),
...
!function() {
    if ("undefined" != typeof self && self.Prism && self.document) {
        ...
        if (!o) {
            ...
            ,
            e.src = "https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/1.5.8/clipboard.min.js",
            n.appendChild(e)
        }
